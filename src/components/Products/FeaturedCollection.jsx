...
const FeaturedCollection = () => {
    return <section className='py-16 px-4 lg:px-0'>
        <div className='container mc-auto flex flex-col-reverse lg:flex-row items-center bg-green-50 rounded-3xl'>
            {/*left content*/}
            ...
            <div className='lg:w-1/2'>
                ...
                className='w-full h-full object-cover lf:rounded-tr-3xl lg:rounded-br-3xl'/>
            </div>
        </div>
    </section>
}
