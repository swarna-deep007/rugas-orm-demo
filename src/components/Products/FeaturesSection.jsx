    ...
    return <section className='py-16 px-4 bg-white '>
        <div className='container mx-auto grid grid-col-1 md:grid-cols-3 gap-8 text-center'>
            <div className='flex flex-col items-center'>
                ...
                <p className='text-gray-600 text-sm tracking-tighter'>On all order above ₹5000 </p>
            </div>
            <div className='flex flex-col items-center'>
                <div className='p-4 rounded-full mb-4'>
            ...
            <div className='flex flex-col items-center'>
                ...
                <p className='text-gray-600 text-sm tracking-tighter'>100% secured chekcout process </p>
            </div>
        </div>
    </section>
}
