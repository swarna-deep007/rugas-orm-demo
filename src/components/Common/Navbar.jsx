    ...
    return (
        <>
            <nav className='container mx-auto flex items-center justify-between py-4 px-6'>
                {/*left-logo*/}
                <div>
                    <Link to="/" className='text-2xl font-medium'>RugasOrder </Link>
                </div>
            ...
            {/* mobile Navigation */}
            <div className={`fixed top-0 left-0 w-3/4 sm:w-1/2 md:w-1/3  h-full bg-white shadow-lg transform transition-transform duration-300 z-50 ${navDrawerOpen ? "transform-x-0" : "-translate-x-full"}`}>
